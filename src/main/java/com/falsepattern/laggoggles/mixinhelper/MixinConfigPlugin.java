...
public class MixinConfigPlugin implements IMixinConfigPlugin{
    ...
    private boolean shouldApplyMixin(String mixin){
        if(spongePresent == true){
            switch (mixin){
                case "com.falsepattern.laggoggles.mixin.MixinWorldServerForge":
                    return false;
            }
        }else{
            switch (mixin){
                case "com.falsepattern.laggoggles.mixin.MixinWorldServerSponge":
                    return false;
            }
        }
        if(hasClientClasses == false){
            switch (mixin) {
                case "com.falsepattern.laggoggles.mixin.MixinRenderManager":
                case "com.falsepattern.laggoggles.mixin.MixinTileEntityRendererDispatcher":
                    return false;
            }
        }
        return true;
    ...
    public void postApply(String target, ClassNode classNode, String mixin, IMixinInfo iMixinInfo) {
        ...
        if(mixin.equals("com.falsepattern.laggoggles.mixin.MixinWorldServerSponge")) {
            LOGGER.info("Applying custom transformer for com.falsepattern.laggoggles.mixin.MixinWorldServerSponge");
